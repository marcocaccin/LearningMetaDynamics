...
krr = KernelRidge(kernel='rbf', gamma=gamma, alpha=1.0e-2, gammaL=0.1*gamma, gammaU=10*gamma, max_lhood=False)
...
ax0.scatter(Xtest, y_, c='b', marker = 'o', alpha = .5)
